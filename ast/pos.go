...
func (c *ColumnDef) End() token.Pos {
	return posChoice(nodeEnd(wrapNode(c.Options)), posAdd(c.Key, 3), posAdd(c.Hidden, 6), nodeEnd(wrapNode(c.PlacementKey)), nodeEnd(wrapNode(c.DefaultSemantics)), posAdd(c.Null, 4), nodeEnd(wrapNode(c.Type)))
}

func (p *PlacementKey) Pos() token.Pos {
	return p.Placement
}

func (p *PlacementKey) End() token.Pos {
	return posAdd(p.Key, 3)
}
...
func (a *AlterColumnSetOnUpdate) Pos() token.Pos {
	return a.Set
}

func (a *AlterColumnSetOnUpdate) End() token.Pos {
	return nodeEnd(wrapNode(a.OnUpdate))
}

func (a *AlterColumnDropOnUpdate) Pos() token.Pos {
	return a.Drop
}

func (a *AlterColumnDropOnUpdate) End() token.Pos {
	return posAdd(a.Update, 6)
}
...
func (u *UpdateItemDML) Pos() token.Pos {
	return u.Lparen
}

func (u *UpdateItemDML) End() token.Pos {
	return posAdd(u.Rparen, 1)
}

func (u *UpdateItemSetValue) Pos() token.Pos {
	return nodePos(nodeSliceIndex(u.Path, 0))
}

func (u *UpdateItemSetValue) End() token.Pos {
...
func (g *GraphTableMatch) Pos() token.Pos {
	return nodePos(wrapNode(g.Match))
}

func (g *GraphTableMatch) End() token.Pos {
	return nodeEnd(nodeChoice(wrapNode(g.Columns), wrapNode(g.Match)))
}

func (g *GraphTableColumns) Pos() token.Pos {
	return g.Columns
}
