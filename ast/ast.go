...
// SequenceParamSkipRange is SKIP RANGE node.
//
//	SKIP RANGE {{.Min | sql}}, {{.Max | sql}}
type SequenceParamSkipRange struct {
	// pos = Skip
	// end = Max.end
...
func (s *SequenceParamSkipRange) SQL() string {
	return "SKIP RANGE " + s.Min.SQL() + ", " + s.Max.SQL()
}

// SequenceParamStartCounterWith is START COUNTER WITH node.
//
//	START COUNTER WITH {{.Counter | sql}}
type SequenceParamStartCounterWith struct {
	// pos = Start
	// end = Counter.end
...
func (s *SequenceParamStartCounterWith) SQL() string {
	return "START COUNTER WITH " + s.Counter.SQL()
}

// SequenceParamBitReversedPositive is BIT_RESVERSED_POSITIVE node.
//
//	BIT_REVERSED_POSITIVE
type SequenceParamBitReversedPositive struct {
...
func (s *SequenceParamBitReversedPositive) SQL() string {
...
func (*SequenceParamBitReversedPositive) isSequenceParam() {}
func (*SequenceParamSkipRange) isSequenceParam()           {}
func (*SequenceParamStartCounterWith) isSequenceParam()    {}
...
func (i *IdentityColumn) SQL() string {
	return "GENERATED BY DEFAULT AS IDENTITY " + sqlJoin(i.Params, " ")
}
...
//	{{if .RestartCounter}}RESTART COUNTER WITH {{.RestartCounter | sqlOpt}}{{end}}
//	{{.SkipRange | sqlOpt}}
//	{{.NoSkipRange | sqlOpt}}
type AlterSequence struct {
	...
	Alter token.Pos // position of "ALTER" keyword
	Range token.Pos // position of "RANGE" keyword of NO SKIP RANGE

	Name    *Path
	Options *Options // optional

	RestartCounter *IntLiteral             // optional
	SkipRange      *SequenceParamSkipRange // optional
...
func (a *AlterColumnAlterIdentity) SQL() string {
	return "ALTER IDENTITY " + a.Alteration.SQL()
}
...
func (r *RestartCounterWith) SQL() string {
	return "RESTART COUNTER WITH " + r.Counter.SQL()
}
...
type SetSkipRange struct {
	...
	Set       token.Pos
	SkipRange *SequenceParamSkipRange
}

func (s *SetSkipRange) SQL() string {
	return "SET " + s.SkipRange.SQL()
}
